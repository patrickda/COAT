...
data <- read_csv("Data/oa-report-normalized.csv")
...
#    version == "info:eu-repo/semantics/submittedVersion" ~ 3,
    ...
    version == "acceptedVersion" ~ 2,
    version == "submittedVersion" ~ 3,
    T  ~ 4
  )) %>%
  ...
  select(identifier, year, institution, country, coat.place, coat.licence, coat.version, coat.embargo, coat.condition)
